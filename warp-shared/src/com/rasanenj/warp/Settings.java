...
public class Settings {
    ...
    public static boolean renderShipVelocity = true;
    public static boolean renderMaxForceRectangle = false;
    public static boolean renderIdealImpulse = false;
    ...
    public static boolean renderPositionProjections = false;
    public static boolean logLatency = false;
    public static final boolean koth = true;
}
